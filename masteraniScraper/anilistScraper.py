...
for line in lines:
    for word in line.split(" "):
        if word.startswith("http"):
            ...
            pattern = "https://www.anilist.co/anime/[\\S]"  # Don't need to re.compile(pattern) because I'm only using it here
...
for url in urls:
    ...
    try:
        ...
        # get stats for ratings, view counts & other js
        # TODO: There is a separate div for tags
